...
(define important-dates
  ...
  `((,(-days (hash-ref deadline-dict 'a1) 4) . "Weekly Readings: Chp 1 and 2 (5.1 and 5.2)")
    ...
    (,(moment 2023 1 6) . "First Day of Lecture")
    #;(,(moment 2023 1 17) . "No lecture; out at POPL")
    #;(,(moment 2023 1 19) . "No lecture; out at POPL")
    (,(moment 2023 1 17) . "Last day to withdraw, without W")
    (,(moment 2023 3 7) . "Last day to withdraw, with W")
    (,(moment 2023 2 17) . "Start of Midterm Break")
    (,(moment 2023 2 21) . "End of Midterm Break")
    (,(moment 2023 4 8) . "Last Day of Lecture")
    (,(moment 2023 4 12) . "Start of exam week")
    (,(moment 2023 4 27) . "End of exam week")
    ))
