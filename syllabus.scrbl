...
In the event of various eventualities, such as extreme weather, illness of both instructors, etc., we will cancel lecture and post activities and notes to be done asynchronously, and be available for Q&A on Piazza.
...
(list
  ...
  (list "Prof. Paulette Koronkevich" @mailto["pletrec@cs.ubc.ca"] "ICICS 306" "Thu 15:30-16:30"))
]
...
Discord, @bold{generative AI tools}, etc.
...
For example, when using a generative AI tool, you can explicitly mark code with comments
as follows:
@examples[
(code:comment "Start Code Generated by TOOLNAME on DATE")
(code:comment "...")
(code:comment "End Code Generated by TOOLNAME on DATE")
]

The course is designed to be an opportunity to practice developing reliable code in
a collaborative environment, and having a clear understanding of the code you produce
is an essential part of that role; this is why we encourage you to write all code yourself.
The instructors and TAs will not help you to debug/understand code which was generated by
a tool, and you must make sure that your project teammates don't end up in this situation:
the code you produce as a software engineer is your own responsibility!
